...
function Introduction() {
  const [showInfo, setShowInfo] = useState(2);
        ...
        <div className="section2-Introduction-container">
          <div className="Section2-Content-title-image">
            ...
            <p className="paragraph2-Introduction">
              ...
              software engineering. Your guidance has been instrumental in
              shaping our career paths.
            </p>
          </div>
          <img
        ...
        <div className="section3-Introduction-container">
          ...
          <div className="Section3-Content-title-image">
            ...
            <p className="paragraph3-Introduction">
              ...
              coding skills but also played a pivoting role in guiding us into
              the software engineering field. You guys expertise and dedication
              has been extremely helpful in shaping our upcoming journies. We
              appreciate your commitment to pull us through challenges, hosting
              a supportive learning environment, and instilling the confidence
              needed to succeed in this dynamic field. Thank you all for being
              the driving force behind our entry into the world of software
              engineering.
            </p>
          </div>
        </div>
        ...
        <div className="section4-Introduction-container">
          <div className="Section2-Content-title-image">
            ...
            <p className="paragraph4-Introduction">
              We here at RTT-34 cohort are fortunate to belong to a diverse
              group, representing various corners of the world, each bringing a
              unique perspective to our coding community. The richness of our
              collective experiences enhances the learning environment, creating
              a tapestry of ideas and cultural insights. Despite our
              differences, we come together with a shared passion for coding,
              forming connections that transcend geographical boundaries. This
              diversity not only fosters a collaborative spirit but also exposes
              us to a wealth of perspectives, making our coding journey not just
              educational but also culturally enriching. It's a privilege to
              learn and grow alongside such a globally diverse and dynamic
              group.
            </p>
          </div>
          <img
  ...
  return (
    <div className="introduction-container">
      ...
      {showInfo === 2 ? sectionTow() : null}
      {showInfo === 3 ? sectionThree() : null}
      {showInfo === 4 ? sectionfour() : null}

      <button className="change-button" onClick={prevSection}>
        Prev
      </button>
      <button className="change-button" onClick={nextSection}>
        Next
      </button>
    </div>
  );
